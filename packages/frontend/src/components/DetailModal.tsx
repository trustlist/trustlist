              ...
              <div className='trust-container'>
                <div className='trust-item'>
                  <Tooltip 
                    ...
                    content=' LP score : '
                  />
                  <div style={{fontWeight: '600'}}>{app.calcScore(listing.pScore1, false)} %</div>
                </div>
                <div className='trust-item'>
                  <Tooltip 
                    ...
                    content=' CB score : '
                  />
                  <div style={{fontWeight: '600'}}>{app.calcScore(listing.pScore2, false)} %</div>
                </div>
                <div className='trust-item'>
                  <Tooltip 
                    ...
                    content=' TD score : '
                  />
                  <div style={{fontWeight: '600'}}>{app.calcScore(listing.pScore3, false)} %</div>
                </div>
                <div className='trust-item'>
                  <Tooltip 
                    ...
                    content=' GV score : '
                  />
                  <div style={{fontWeight: '600'}}>{app.calcScore(listing.pScore4, true)} %</div>
                </div>
              </div>  
            </div>
                ...
                <div style={{display: 'flex'}}>
                  ...
                  {offers ? 
                    ...
                    <div key={offer._id} className='offer'>
                      ...
                      <div className='offer-score'><span style={{fontWeight: '300'}}>CB: </span>{app.calcScore(listing.pScore2, false)} </div>
                      <div className='offer-score'><span style={{fontWeight: '300'}}>TD: </span>{app.calcScore(listing.pScore1, false)} </div>
                      <div className='offer-score'><span style={{fontWeight: '300'}}>GV: </span>{app.calcScore(listing.pScore1, true)} </div> 
