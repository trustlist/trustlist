                    ...
                    return (
                        <FormItem>
                            <FormLabel className="text-base">
                                Enter the amount you're offering
                            </FormLabel>
                            <FormControl>
                                <Input
                                    {...field}
...
const NewOfferPage = () => {
    ...
    const submitOfferAlert = (newData: any) =>
        toast.promise(makeOffer(newData), {
            pending:
            ...
            success: {
                render: (
                    <div className="flex space-around gap-3">
                        <div>
                            <div>
                                Offer submitted! One "initiated" point will be
                                added to your LO score if your offer is accepted
                                by the lister.
                            </div>
                            <div>
                                You will have access to the lister's contact
                                info if they accept your offer, open your
                                Dashboard to check the status.{' '}
                            </div>
                        </div>
                        <button
    ...
    return (
        <Form {...listForm}>
            <form
                onSubmit={listForm.handleSubmit(submitOffer, onFormError)}
