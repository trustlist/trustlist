...
import {
    TrustScoreKeyEnum,
    listingCategories,
    trustScores as trustScoresFromData,
} from '@/data'
...
const FormSteps: FormStep[] = [
    ...
    { id: 'trust-scores', description: 'Choose which trust scores to show' },
]
                            ...
                            return (
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem
                                            key={index}
                                            className="flex justify-center items-center space-x-1 space-y-0"
                                        >
                                            <FormControl>
                                                <Checkbox
                                                    id={newLabel}
                                            ...
                                            <FormLabel
                                                htmlFor={newLabel}
                                                className="text-base text-foreground hover:cursor-pointer active:text-foreground hover:text-foreground hover:underline underline-offset-1"
                                            >
                                                {category}
                                            </FormLabel>
                                        </FormItem>
...
const TrustScoreFormStep = ({
    control,
    scores,
}: StepSectionProps & { scores: number[] }) => {
    return (
        <section className="flex flex-col space-y-4">
                    ...
                    render={({ field }) => (
                        ...
                        >
                            <div>
                                ...
                                <FormDescription className="text-foreground-700">
            ...
            >
                ...
                {currentStep < FormSteps.length && (
                    <button
                        ...
                        onClick={() => changeStep(FormSteps[currentStep])}
                    >
                        Next step
                    </button>
                )}
...
const NewListingPage = () => {
    ...
    React.useEffect(() => {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            let data = trustlist.calcScoreFromUserData(
