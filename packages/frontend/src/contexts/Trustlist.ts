...
class Trustlist {
  ...
  async load() {
    ...
    this.forSaleByCategory.set('antiques', [{_id: '54321', epoch: 13, section: 'for sale', title: 'Really old chair', amount: '200', amountType: 'one time', score1: '56', score2: '77', score3: '67', score4: "81", description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.'}, {_id: '12345', epoch: 10, section: 'for sale', title: 'Vintage Lamp', amount: '125', amountType: 'one time', score1: '44', score2: '87', score3: '66', score4: '99', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.'}])
  ...
  async createNewListing(epoch: number | undefined, section: string, category: string, title: string, amount: string, amountType: string, description: string, posterId: string, score1: string, score2: string, score3: string, score4: string) {
